			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active"><?php echo word_limiter($vendor['vendor'],3);?></li>
					</ol>
				</div>
			</div>
		</div>
				...
				<div class="card card-earnings">
					<div class="p-2 card">
						<form class="user" id="validate" method="post" novalidate="novalidate"
							action="<?php echo base_url("vendor/".$vendor['vendor_id']);?>">
							...
							<div class="form-group">
								...
								<input type="text"
									...
									id="phone" name="phone" required placeholder="Enter phone" value="<?php echo $vendor['phone'];?>" />
							...
							<div class="form-group">
								...
								<input type="text"
									...
									value="<?php echo $vendor['website'];?>" />
								<span class="is-invalid"><?php echo form_error('website');?></span>
							</div>
                            <div class="form-group">
                            	...
                            	<input type="text"
                            		...
                            		value="<?php echo $vendor['contactPerson'];?>" />
                            ...
                            <div class="form-group">
                            	...
                            	<input type="text"
                            		...
                            		value="<?php echo $vendor['location'];?>" />
