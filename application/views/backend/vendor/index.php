						...
						<table id="example1" class="table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo word_limiter($row['location'],3); ?></td>
									<td><?php echo word_limiter($row['contactPerson'],3); ?></td>
									<td>
										<a class="btn btn-light btn-sm"
											href="<?php echo 'vendor/'.$row['vendor_id']; ?>">
											<i class="fa fa-pencil-alt"></i>
										</a>
										<button class="btn btn-light btn-sm" data-toggle="modal"
											data-target="#delete<?php print $row['vendor_id']; ?>">
...
<?php foreach($vendor as $key=>$row): ?>
<div class="modal" id="delete<?php echo $row['vendor_id'];?>">
	<div class="modal-dialog modal-confirm" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>
					Do you really want to delete the vendor<br/>
			...
			<div class="modal-footer justify-content-center mb-3">
				<?php echo form_open_multipart('vendor/'.$row['vendor_id'].'/delete');?>
