						...
						<table id="example1" class="table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a class="btn btn-light btn-sm" href="<?php echo 'driver/'.$row['driver_id']; ?>">
											<i class="fa fa-pencil-alt"></i>
										</a>
										<button class="btn btn-light btn-sm" data-toggle="modal"
											data-target="#delete<?php print $row['driver_id']; ?>">
...
<?php foreach($driver as $key=>$row): ?>
<div class="modal" id="delete<?php echo $row['driver_id'];?>">
	<div class="modal-dialog modal-confirm" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>
					Do you really want to delete the driver <br />
			...
			<div class="modal-footer justify-content-center mb-3">
				<?php echo form_open_multipart('driver/'.$row['driver_id'].'/delete');?>
