			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active"><?php echo $driver['firstname'];?></li>
					</ol>
				</div>
			</div>
		</div>
				...
				<div class="card card-earnings">
					<div class="p-2 card">
						<form class="user" id="validate" method="post" novalidate="novalidate"
							action="<?php echo base_url("driver/".$driver['driver_id']);?>">
							<div class="form-group">
								...
								<input type="text"
									...
									value="<?php echo $driver['firstname'];?>" />
							...
							<div class="form-group">
								...
								<input type="text"
									...
									value="<?php echo $driver['lastname'];?>" />
							...
							<div class="form-group">
								...
								<select class="form-control" name="vehicle_id" id="vehicle_id" required>
									<option value="<?php echo $driver['vehicle_id'];?>"><?php echo $driver['vehicle'];?>
									</option>
