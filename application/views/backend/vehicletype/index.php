				...
				<div class="card card-earnings">
					<div class="p-2 card">
						...
						<table id="example1" class="table table-bordered">
							...
							<tbody>
								<?php foreach($vehicletype as $key=>$row): ?>
								<tr>
									<td><?php echo $key + 1; ?></td>
									<td><?php echo word_limiter($row['vehicletype'],3); ?></td>
									<td>
										<a class="btn btn-light btn-sm"
											href="<?php echo 'vehicle-type/'.$row['vehicletype_id']; ?>">
											<i class="fa fa-pencil-alt"></i>
										</a>
										<button class="btn btn-light btn-sm" data-toggle="modal"
											data-target="#delete<?php print $row['vehicletype_id']; ?>">
...
<?php foreach($vehicletype as $key=>$row): ?>
<div class="modal" id="delete<?php echo $row['vehicletype_id'];?>">
	<div class="modal-dialog modal-confirm" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>
					Do you really want to delete the vehicle type <br/>
					<strong><?php echo $row['vehicletype']; ?> </strong>?
					<br>
					This process cannot be undone.
				</p>
			</div>
			<div class="modal-footer justify-content-center mb-3">
				<?php echo form_open_multipart('vehicle-type/'.$row['vehicletype_id'].'/delete');?>
				<input type="hidden" name="id" value="<?php echo $row['vehicletype_id'];?>">
