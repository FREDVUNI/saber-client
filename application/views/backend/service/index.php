<div class="content-wrapper" style="min-height:540.031px">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h4 class="m-0 text-muted">Servicings</h4>
				</div>
				<div class="col-sm-6">
						...
						<table id="example1" class="table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo word_limiter($row['service'],3); ?></td>
									<td><?php echo word_limiter($row['vehicle'],3); ?></td>
									<td><?php echo word_limiter($row['license_plate'],3); ?></td>
									<td><?php echo $row['vendor']; ?></td>
									<td><?php echo $row['amount']; ?></td>
									<td>
										<!-- <a class="btn btn-light btn-sm" href="<?php echo 'service/'.$row['service_id']; ?>">
											<i class="fa fa-pencil-alt"></i>
										</a> -->
										<button class="btn btn-light btn-sm" data-toggle="modal"
											data-target="#delete<?php print $row['service_id']; ?>">
...
<?php foreach($service as $key=>$row): ?>
<div class="modal" id="delete<?php echo $row['service_id'];?>">
	<div class="modal-dialog modal-confirm" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer justify-content-center mb-3">
				<!-- <?php ///echo form_open_multipart('service/'.$row['service_id'].'/delete');?> -->
				<?php echo form_open_multipart('404');?>
