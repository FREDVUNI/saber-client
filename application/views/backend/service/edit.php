			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active"><?php echo word_limiter($service['service'],3);?></li>
					</ol>
				</div> 
			</div>
		</div>
				...
				<div class="card card-earnings">
					<div class="p-2 card">
						<form class="user" id="validate" method="post" novalidate="novalidate"
							action="<?php echo base_url("service/".$service['service_id']);?>">
							...
							<div class="form-group">
								...
								<select class="form-control" name="vehicle_id" id="vehicle_id" required>
									<option value="<?php echo $service['vehicle_id'];?>"><?php echo $service['vehicle'];?></option>
							...
							<div class="form-group">
								...
								<input type="text"
									...
									id="service" name="service" required placeholder="Enter license plate"
									value="<?php echo $service['service'];?>" />
							...
							<div class="form-group">
								...
								<select class="form-control" name="vendor_id" id="vendor_id" required>
									<option value="<?php echo $service['vendor_id'];?>"><?php echo $service['vendor'];?></option>
							...
							<div class="form-group">
								...
								<input type="text"
									...
									value="<?php echo $service['comment'];?>" />
								<span class="is-invalid"><?php echo form_error('comment');?></span>
							</div>
							<div class="form-group">
								<img src="<?php echo base_url('assets/uploads/receipts/'.$service['payment_receipt']);?>" alt="receipt"
									class="" id="vendorImg" width="200" height="210">
								<input type="file" id="image" name="userfile" style="display: none;"
									accept=".jpg,.jpeg,.png,.gif" required />
								<div class="col-md-12 text-center">
									<div class="row ml-3">
										<div class="mt-2">
											<a href="javascript:vendorImg()">upload image</a>
...
<script>
	...
	function DeleteImage() {
		$('#vendorImg').attr('src', '<?php echo base_url('assets/uploads/receipts/noimage.png ');?>');
		$('#imageerror').text('')
	}
</script>
<script>
