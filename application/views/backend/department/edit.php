			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active"><?php echo $department['department'];?></li>
					</ol>
				</div>
			</div>
		</div>
				...
				<div class="card card-earnings">
					<div class="p-2 card">
						<form class="user" id="validate" method="post" novalidate="novalidate"
							action="<?php echo base_url("department/".$department['id']);?>">
							<div class="form-group">
								...
								<input type="text"
									...
									value="<?php echo $department['department'];?>" />
