<div class="content-wrapper" style="min-height:540.031px">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h4 class="m-0 text-muted">Users</h4>
				</div>
				<div class="col-sm-6">
						...
						<table id="example1" class="table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo word_limiter($row['firstname'],3); ?></td>
									<td><?php echo word_limiter($row['lastname'],3); ?></td>
									<td><?php echo $row['email']; ?></td>
									<td><?php echo $row['department']; ?></td>
									<td><?php echo $row['phone']; ?></td>
									<td>
										<a class="btn btn-light btn-sm" href="<?php echo 'user/'.$row['user_id']; ?>">
											<i class="fa fa-pencil-alt"></i>
										</a>
										<button class="btn btn-light btn-sm" data-toggle="modal"
											data-target="#delete<?php print $row['user_id']; ?>">
...
<?php foreach($user as $key=>$row): ?>
<div class="modal" id="delete<?php echo $row['user_id'];?>">
	<div class="modal-dialog modal-confirm" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer justify-content-center mb-3">
				<?php echo form_open_multipart('user/'.$row['user_id'].'/delete');?>
