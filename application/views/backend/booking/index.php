<div class="content-wrapper" style="min-height:540.031px">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h4 class="m-0 text-muted">Bookings</h4>
				</div>
				<div class="col-sm-6">
						...
						<table id="example1" class="table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo word_limiter($row['reason'],3); ?></td>
									<td><?php echo word_limiter($row['period'],3); ?></td>
									<td><?php echo word_limiter($row['destination'],3); ?></td>
									<td>
	...
	<div class="modal-dialog modal-confirm" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer justify-content-center mb-3">
				<?php echo form_open_multipart('booking/'.$row['id'].'/delete');?>
